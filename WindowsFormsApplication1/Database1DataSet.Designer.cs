...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class HistoryDataTable : global::System.Data.TypedTableBase<HistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public HistoryRow AddHistoryRow(int Id, string Ssid, string Key) {
        ...
        public partial class HistoryRow : global::System.Data.DataRow {
            ...
            public string Ssid {
                get {
                    return ((string)(this[this.tableHistory.SsidColumn]));
                }
                set {
                    this[this.tableHistory.SsidColumn] = value;
                }
            }
            ...
            public string Key {
                get {
                    return ((string)(this[this.tableHistory.KeyColumn]));
                }
                set {
                    this[this.tableHistory.KeyColumn] = value;
                }
            }
        }
...
namespace WindowsFormsApplication1.Database1DataSetTableAdapters {
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[History] ([Id], [Ssid], [Key]) VALUES (@Id, @Ssid, @Key);\r\nSEL" +
                "ECT Id, Ssid, [Key] FROM History WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[History] SET [Id] = @Id, [Ssid] = @Ssid, [Key] = @Key WHERE (([Id] " +
                "= @Original_Id));\r\nSELECT Id, Ssid, [Key] FROM History WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Ssid, [Key] FROM dbo.History";
        ...
        public virtual int Insert(int Id, string Ssid, string Key) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((Ssid == null)) {
                throw new global::System.ArgumentNullException("Ssid");
            }
            else {
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(Ssid));
            }
            if ((Key == null)) {
        ...
        public virtual int Update(int Id, string Ssid, string Key, int Original_Id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((Ssid == null)) {
                throw new global::System.ArgumentNullException("Ssid");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Ssid));
            }
            if ((Key == null)) {
                throw new global::System.ArgumentNullException("Key");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Ssid, string Key, int Original_Id) {
            return this.Update(Original_Id, Ssid, Key, Original_Id);
        }
    }
